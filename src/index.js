...
var _initialiseProps = function _initialiseProps() {
  ...
  this.fetchSuggestions = function () {
    ...
    payload.locations = [
      ...
      {country: 'Австрия'},
      {country: 'Азербайджан'},
      {country: 'Албания', category: 2},
      {country: 'Армения', category: 1},
      {country: 'Беларусь', category: 1},
      {country: 'Бельгия', category: 2},
      {country: 'Болгария', category: 2},
      {value: 'Босния и Герциговина', country: 'Босния и Герциговина', category: 2},
      {value: 'Великобритания', country: 'Великобритания', category: 2},
      {value: 'Венгрия', country: 'Венгрия', category: 2},
      {value: 'Вьетнам', country: 'Вьетнам', category: 4},
      {value: 'Германия', country: 'Германия', category: 2},
      {value: 'Гонконг', country: 'Гонконг', category: 4},
      {value: 'Греция', country: 'Греция', category: 2},
      {value: 'Грузия', country: 'Грузия', category: 1},
      {value: 'Дания', country: 'Дания', category: 2},
      {value: 'Египет', country: 'Египет', category: 4},
      {value: 'Израиль', country: 'Израиль', category: 3},
      {value: 'Индия', country: 'Индия', category: 4},
      {value: 'Индонезия', country: 'Индонезия', category: 4},
      {value: 'Иран', country: 'Иран', category: 4},
      {value: 'Ирландия', country: 'Ирландия', category: 3},
      {value: 'Исландия', country: 'Исландия', category: 3},
      {value: 'Испания', country: 'Испания', category: 2},
      {value: 'Испания (Канарские острова)', country: 'Испания (Канарские острова)', category: 6},
      {value: 'Италия', country: 'Италия', category: 2},
      {value: 'kz', country: 'Казахстан', category: 1},
      {value: 'Канада', country: 'Канада', category: 3},
      {value: 'Кипр', country: 'Кипр', category: 3},
      {value: 'Китай', country: 'Китай', category: 3},
      {value: 'Латвия', country: 'Латвия', category: 2},
      {value: 'Литва', country: 'Литва', category: 2},
      {value: 'Лихтенштейн', country: 'Лихтенштейн', category: 2},
      {value: 'Люксембург', country: 'Люксембург', category: 2},
      {value: 'Малайзия', country: 'Малайзия', category: 3},
      {value: 'Мальта', country: 'Мальта', category: 3},
      {value: 'Молдова', country: 'Молдова', category: 1},
      {value: 'Монако', country: 'Монако', category: 2},
      {value: 'Монголия', country: 'Монголия', category: 3},
      {value: 'Нидерланды', country: 'Нидерланды', category: 2},
      {value: 'Новая Зеландия', country: 'Новая Зеландия', category: 5},
      {value: 'Норвегия', country: 'Норвегия', category: 2},
      {value: 'ОАЭ', country: 'ОАЭ', category: 4},
      {value: 'Польша', country: 'Польша', category: 2},
      {value: 'Португалия', country: 'Португалия', category: 2},
      {value: 'Румыния', country: 'Румыния', category: 2},
      {value: 'Сан-Марино', country: 'Сан-Марино', category: 2},
      {value: 'Сербия', country: 'Сербия', category: 2},
      {value: 'Сингапур', country: 'Сингапур', category: 3},
      {value: 'Сирия', country: 'Сирия', category: 3},
      {value: 'Словакия', country: 'Словакия', category: 2},
      {value: 'Словения', country: 'Словения', category: 2},
      {value: 'США', country: 'США', category: 3},
      {value: 'Таджикистан', country: 'Таджикистан', category: 1},
      {value: 'Таиланд', country: 'Таиланд', category: 4},
      {value: 'Тайвань', country: 'Тайвань', category: 4},
      {value: 'Туркменистан', country: 'Туркменистан', category: 1},
      {value: 'Турция', country: 'Турция', category: 2},
      {value: 'Узбекистан', country: 'Узбекистан', category: 1},
      {value: 'ua', country: 'Украина', category: 1},
      {value: 'Финляндия', country: 'Финляндия', category: 2},
      {value: 'Франция', country: 'Франция', category: 2},
      {value: 'Хорватия', country: 'Хорватия', category: 2},
      {value: 'Черногория', country: 'Черногория', category: 2},
      {value: 'Чехия', country: 'Чехия', category: 2},
      {value: 'Швейцария', country: 'Швейцария', category: 2},
      {value: 'Швеция', country: 'Швеция', category: 2},
      {value: 'Эстония', country: 'Эстония', category: 2},
      {value: 'ЮАР', country: 'ЮАР', category: 5},
      {value: 'Япония', country: 'Япония', category: 3},
    ];
